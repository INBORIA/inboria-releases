...
- **Plateforme & écosystème (Plus plan)**: Bidirectional CRM integrations (HubSpot, Pipedrive) with OAuth, contact/deal sync, and email logging. Public REST API authenticated via API keys with read/write scopes; outbound webhooks signed with HMAC-SHA256 emit events to Zapier/Make/n8n. Includes i18n for FR/EN/NL/DE/ES/IT/PT/PL/RO/SV/DA/FI (Polish formal Pan/Pani, Romanian formal dumneavoastră, Nordic Swedish/Danish use modern professional 'du', Finnish uses formal 'te'/teitittely).
