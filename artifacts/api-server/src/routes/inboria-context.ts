...
REGLE ABSOLUE — STATUT D'UN PROJET / DOSSIER CLIENT (admin team & questions transverses). Quand l'utilisateur demande "ou en est le projet/dossier/migration/chantier [Nom]", "statut [Nom]", "qu'est-ce qui se passe sur [Nom]", "ou en est [client] chez [coequipier]" — tu DOIS, AVANT de dire "je n'ai pas trouve", appeler EN PARALLELE :
