                    ...
                    : isPt
                      ...
                      : isPl
                        ...
                        : isRo
                          ...
                          : isSv
                            ? "Aktiva projekt (senaste 7 dagars aktivitet)"
                            : isDa
                              ? "Aktive projekter (seneste 7 dages aktivitet)"
                              : isFi
                                ? "Aktiiviset projektit (viimeiset 7 päivää aktiivisuutta)"
                                : isHu
                                  ? "Aktív projektek (utolsó 7 nap aktivitása)"
                                  : isCs
                                    ? "Aktivní projekty (posledních 7 dní aktivity)"
                                    : isTr
                                      ? "Aktif projeler (son 7 günün aktivitesi)"
                                      : isJa
                                        ? "アクティブなプロジェクト（過去7日間のアクティビティ）"
                                        : isKo
                                          ? "활성 프로젝트 (최근 7일간의 활동)"
                                          : isVi
                                            ...
                                            : isTh
                                              ...
                                              : isId
                                                ? "Proyek aktif (aktivitas 7 hari terakhir)"
                                                : isMs
                                                  ? "Projek aktif (aktiviti 7 hari lepas)"
                                                  : isEl
                                                    ? "Ενεργά έργα (δραστηριότητα τις τελευταίες 7 ημέρες)"
                                                    : isUk
                                                      ? "Активні проєкти (активність за останні 7 днів)"
                                                      : isEt
                                                        ? "Aktiivsed projektid (viimase 7 päeva aktiivsus)"
                                                        : isZh
                                                          ? "活跃项目(过去 7 天的活动)"
                                                          : isZhTw
                                                            ? "活躍專案(過去 7 天的活動)"
                                                            : isLt
                                                              ? "Aktyvūs projektai (paskutinių 7 dienų veikla)"
                                                              : isSr
                                                                ...
                                                                : isRu
                                                                  ...
                                                                  : isHe
                                                                    ...
                                                                    : isAr
                                                                      ? "المشاريع النشطة (نشاط آخر 7 أيام)"
                                                                      : isHr
                                                                        ? "Aktivni projekti (aktivnost u zadnjih 7 dana)"
                                                                        : isSk
                                                                          ? "Aktívne projekty (aktivita za posledných 7 dní)"
                                                                          : isSl
                                                                            ? "Aktivni projekti (aktivnost v zadnjih 7 dneh)"
                                                                            : isLv
                    ...
                    : isPt
                      ...
                      : isPl
                        ...
                        : isRo
                          ...
                          : isSv
                            ? "Senaste beslut (senaste 7 dagarna)"
                            : isDa
                              ? "Seneste beslutninger (seneste 7 dage)"
                              : isFi
                                ? "Viimeaikaiset päätökset (viimeiset 7 päivää)"
                                : isHu
                                  ? "Friss döntések (utolsó 7 nap)"
                                  : isCs
                                    ? "Nedávná rozhodnutí (posledních 7 dní)"
                                    : isTr
                                      ? "Son kararlar (son 7 gün)"
                                      : isJa
                                        ? "最近の決定事項（過去7日間）"
                                        : isKo
                                          ? "최근 결정 사항 (최근 7일)"
                                          : isVi
                                            ...
                                            : isTh
                                              ...
                                              : isId
                                                ? "Keputusan terbaru (7 hari terakhir)"
                                                : isMs
                                                  ? "Keputusan terkini (7 hari lepas)"
                                                  : isEl
                                                    ? "Πρόσφατες αποφάσεις (τελευταίες 7 ημέρες)"
                                                    : isUk
                                                      ? "Останні рішення (останні 7 днів)"
                                                      : isEt
                                                        ? "Hiljutised otsused (viimased 7 päeva)"
                                                        : isZh
                                                          ? "近期决定(过去 7 天)"
                                                          : isZhTw
                                                            ? "近期決定(過去 7 天)"
                                                            : isLt
                                                              ? "Naujausi sprendimai (paskutinės 7 dienos)"
                                                              : isSr
                                                                ...
                                                                : isRu
                                                                  ...
                                                                  : isHe
                                                                    ...
                                                                    : isAr
                                                                      ? "القرارات الأخيرة (آخر 7 أيام)"
                                                                      : isHr
                                                                        ? "Nedavne odluke (zadnjih 7 dana)"
                                                                        : isSk
                                                                          ? "Nedávne rozhodnutia (posledných 7 dní)"
                                                                          : isSl
                                                                            ? "Nedavne odločitve (zadnjih 7 dni)"
                                                                            : isLv
                    ...
                    : isPt
                      ...
                      : isPl
                        ...
                        : isRo
                          ...
                          : isSv
                            ? "Åtaganden som nämnts denna vecka"
                            : isDa
                              ? "Forpligtelser nævnt denne uge"
                              : isFi
                                ? "Tällä viikolla mainitut sitoumukset"
                                : isHu
                                  ? "E heti említett kötelezettségek"
                                  : isCs
                                    ? "Závazky zmíněné tento týden"
                                    : isTr
                                      ? "Bu hafta belirtilen taahhütler"
                                      : isJa
                                        ? "今週言及されたコミットメント"
                                        : isKo
                                          ? "이번 주 언급된 약속"
                                          : isVi
                                            ...
                                            : isTh
                                              ...
                                              : isId
                                                ? "Komitmen yang disebutkan minggu ini"
                                                : isMs
                                                  ? "Komitmen yang dinyatakan minggu ini"
                                                  : isEl
                                                    ? "Δεσμεύσεις που αναφέρθηκαν αυτή την εβδομάδα"
                                                    : isUk
                                                      ? "Зобов'язання, згадані цього тижня"
                                                      : isEt
                                                        ? "Sel nädalal mainitud kohustused"
                                                        : isZh
                                                          ? "本周提及的承诺"
                                                          : isZhTw
                                                            ? "本週提及的承諾"
                                                            : isLt
                                                              ? "Šią savaitę paminėti įsipareigojimai"
                                                              : isSr
                                                                ...
                                                                : isRu
                                                                  ...
                                                                  : isHe
                                                                    ...
                                                                    : isAr
                                                                      ? "الالتزامات المذكورة هذا الأسبوع"
                                                                      : isHr
                                                                        ? "Obveze spomenute ovog tjedna"
                                                                        : isSk
                                                                          ? "Záväzky spomenuté tento týždeň"
                                                                          : isSl
                                                                            ? "Obveznosti, omenjene ta teden"
                                                                            : isLv
