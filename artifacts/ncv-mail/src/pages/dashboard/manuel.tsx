...
const sections = [
  {
    ...
    features: [
      ...
      "Synchronisation manuelle ou automatique (toutes les 5 min)",
  ...
  },
  {
    ...
    description:
      "Gérez vos catégories d'emails. L'IA crée automatiquement des catégories pertinentes, mais vous pouvez les personnaliser.",
    features: [
