            ...
            <Dialog open={isSimulateOpen} onOpenChange={setIsSimulateOpen}>
              <DialogTrigger asChild>
                <Button
                  ...
                  title={t("inbox.triageTitle")}
                >
                  <Sparkles className="w-3 h-3" />
                  <span className="hidden sm:inline">{t("inbox.triageTitle")}</span>
                </Button>
              </DialogTrigger>
              <DialogContent className="bg-card border-border w-[95vw] sm:max-w-lg">
                <DialogHeader>
                  <DialogTitle className="text-white text-[14px] flex items-center gap-2">
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmitTriage)} className="space-y-3">
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px] text-[#8b9cb3] uppercase tracking-wider">
                            {t("compose.from", "Expéditeur")}
                          </FormLabel>
                          <FormControl>
                            <Input
                              {...field}
                              placeholder="client@example.com"
                              className="bg-background border-border text-white text-[12px]"
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-[11px] text-[#8b9cb3] uppercase tracking-wider">
                            {t("compose.subject", "Sujet")}
                          </FormLabel>
                          <FormControl>
                            <Input
                              {...field}
                              placeholder={t("inbox.triageTitle")}
                              className="bg-background border-border text-white text-[12px]"
                            />
                          </FormControl>
                          <FormMessage />
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea
                              ...
                              className="bg-background border-border text-white text-[12px] resize-none"
                            />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <Button
                        type="submit"
                        size="sm"
                        disabled={triageEmail.isPending}
                        className="gap-1.5 h-8 text-[11px]"
                      >
                        {triageEmail.isPending ? (
