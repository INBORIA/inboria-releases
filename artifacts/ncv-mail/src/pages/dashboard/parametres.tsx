...
export default function Parametres() {
  ...
  const cards: HubCard[] = [
    ...
    },
    {
      ...
      icon: MessageCircle,
      titleKey: "settings.hub.multichannel",
      titleFallback: "Multi-canal client",
      descKey: "settings.hub.multichannelDesc",
      descFallback: "WhatsApp, SMS",
      testId: "hub-card-multichannel",
    },
    {
