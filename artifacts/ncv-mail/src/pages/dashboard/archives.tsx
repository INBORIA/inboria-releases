...
import { Archive, Clock, Inbox, ArrowLeft, Trash2, RotateCcw, ChevronRight, FolderOpen } from "lucide-react";
      ...
      <div className="p-6 max-w-5xl mx-auto w-full">
        ...
        {emailsLoading ? (
          ...
          <div className="text-center py-20 rounded-lg border border-border border-dashed bg-card/50">
            ...
            <p className="text-[13px] text-[#8b9cb3]">Les emails a faible priorite seront automatiquement archives ici.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
