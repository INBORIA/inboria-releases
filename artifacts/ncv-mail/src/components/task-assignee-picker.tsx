    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <ChevronDown className="w-3 h-3 text-[#b8c5d6] shrink-0" />
        </button>
      </PopoverTrigger>
      <PopoverContent className={className || "w-64 p-1.5 bg-card border-border"} align="start">
        <div className="text-[10px] uppercase tracking-wider text-[#b8c5d6] px-2 py-1">
        ...
        {me && (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {me.email && (
                <div className="text-[10px] text-[#b8c5d6] truncate">{me.email}</div>
              )}
            </div>
        ...
        {others.length === 0 && (
          <div className="px-2 py-2 text-[11px] text-[#b8c5d6]">
