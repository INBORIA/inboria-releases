...
export function LanguageSwitcher({ variant = "default" }: { variant?: "default" | "compact" }) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-1 w-56 rounded-lg border border-[#1f2937] bg-[#11161d] shadow-xl z-[100] max-h-80 overflow-y-auto overscroll-contain">
          {languages.map((lang) => (
            <button
              key={lang.code}
              onClick={() => {
