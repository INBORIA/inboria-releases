...
Unité de base : **1 crédit ≈ coût d'un triage standard ≈ 0,000405 €**.
...
| **Mail envoyé via Brevo** | **8** | couvre 0,003 € de coût SMTP réel (8 × 0,000405 € = 0,00324 €) |
| Lecture, recherche, tri, ouverture | **gratuit** | aucun appel IA ni envoi |
...
| Mails envoyés via Brevo | **30% des reçus = 1 050** | **8** | **8 400** |
...
| **TOTAL crédits consommés** | | | **16 179** |

#### Coûts directs réels associés (worst case mixte)

| Poste | Calcul | Montant |
|---|---|---|
| OpenAI (toutes actions hors envoi) | détail ci-dessous | **2,00 €** |
| Brevo SMTP | 1 050 × 0,003 € | **3,15 €** |
| Supabase (100 abonnés actifs) | mutualisé | 1,00 € |
| Replit (100 abonnés actifs) | mutualisé | 0,55 € |
| **Sous-total infra + IA + envoi** | | **6,70 €** (hors Paddle) |

*Détail OpenAI : triage 1,07 € + brouillons/régén/variantes 0,41 € + relances 0,05 € + résumés 0,13 € + reclassif 0,12 € + chat 0,19 € + brief 0,02 € + projets 0,01 € = 2,00 €.*

#### Marge worst case mixte par plan

| Plan | Crédits inclus | Dépassement | Revenu PAYG | Revenu total | Coûts directs + Paddle | **Marge** | **%** |
|---|---|---|---|---|---|---|---|
| **Solo** (9 €) | 3 000 | 13 179 × 0,0012 € | 15,81 € | **24,81 €** | 6,70 + 2,00 (2 tx Paddle) = 8,70 € | **+16,11 €** | **65%** ✅ |
| **Pro** (19 €) | 10 000 | 6 179 × 0,0012 € | 7,41 € | **26,41 €** | 6,70 + 2,00 = 8,70 € | **+17,71 €** | **67%** ✅ |
| **Business** (9 €/siège, 3 sièges) | 10 000/siège | 6 179 × 0,0012 € | 7,41 €/siège | **16,41 €/siège** | 6,70 + 0,62 + 0,50 = 7,82 € | **+8,59 €/siège** | **52%** ✅ |

**Conclusion** : avec le mail envoyé intégré au barème de crédits (8 crédits/envoi) et un Pay-as-you-go uniformisé en crédits, **les trois plans deviennent étanches au pire cas mixte**, sans aucun changement de prix ni de quota. Le Business à 9 €/siège, qui était déficitaire de −2,72 € dans le modèle actuel, repasse à +8,59 €/siège.
