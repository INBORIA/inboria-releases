...
**Why:** symptôme réel — `support@inboria.com` (boîte partagée OVH) affichait 0 mail ; les copies reçues étaient déduppées contre les copies perso au même Message-ID (`duplicatesSkipped:1` à chaque cycle).
